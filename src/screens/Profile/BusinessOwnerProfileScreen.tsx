/**
 * BusinessOwnerProfileScreen Component - WITH LEGAL SECTION & ADMIN TOOLS
 * 
 * Last Updated: February 8, 2026
 * Changes: 
 * - Removed manual token passing - API client handles it automatically
 * - Added is_admin fetching from database
